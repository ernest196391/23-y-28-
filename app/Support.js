...
export default function Support({onAdd,cart={}}){
  ...
  async function ask(text,attachments=files){
    ...
    try{
      ...
      setMessages(m=>[...m,{role:"assistant",text:data.answer,products:data.products,contact:data.contact}]);setQ("");setFiles([]);
